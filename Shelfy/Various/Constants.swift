...
struct K {
    ...
    static let levels = ["Novice Reader 📖",
                         "Page Turner 📚",
                         "Bookworm 🐛",
                         "Bibliophile 📜",
...
struct EmptyTable {
    ...
    static let collectionMsg = ["Uh-oh! This category is as barren as a bookshelf in a ghost town! 👻📚 Time to summon some literary spirits!","Looks like this category is feeling rather bookish... empty! 📚🔍 Let's fill it with stories that sparkle like literary diamonds!","Whoops-a-daisy! This category seems to have lost its plot... and its books! 📖🌪️ Let's script a new chapter together!","Houston, we have a problem! This category is as empty as the vastness of space! 🌌📚 Time to launch some intergalactic reads!","Yikes! This category feels as empty as a library during a zombie apocalypse! 🧟‍♂️📚 Let's revive it with some undead reads!","Oh dear! This category is as bare as a bookshop in a parallel universe! 🌌📚 Let's warp into action and stock it up!","Well, butter my book biscuit! This category is as empty as a cookbook in a vegan cafe! 🥦📚 Time to add some flavor!","Egads! This category is as desolate as a bookshelf in a haunted house! 👻📚 Let's bring in some spectral stories!","Oh no, Sherlock! This category seems to have lost its clues... and its books! 🔍📚 Let's solve this mystery with a literary twist!","Drat! This category is as vacant as a library without a librarian! 📚🕵️‍♂️ Time to don the reading glasses and fill it up!"]
