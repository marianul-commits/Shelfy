...
class TestView: UIViewController, UITextFieldDelegate, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(MoreByCell.self, forCellWithReuseIdentifier: "testIdentifier")
        ...
        NSLayoutConstraint.activate([
            ...
            collectionView.topAnchor.constraint(equalTo: colorView.topAnchor, constant: 20),
            collectionView.leadingAnchor.constraint(equalTo: colorView.leadingAnchor),
            collectionView.trailingAnchor.constraint(equalTo: colorView.trailingAnchor),
            collectionView.bottomAnchor.constraint(equalTo: colorView.bottomAnchor, constant: -470),
            //
            //            //top right
            ...
            colorView.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -10)
            //
